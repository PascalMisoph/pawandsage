...
affiliateProducts:
  ...
  - name: Petstages Tower of Tracks
    asin: B001J9AHM0
    price: ~$12
  - name: Potaroma Flopping Fish
    asin: B07NDKBC6X
    price: ~$20
  - name: PetFusion Ambush
    asin: B01ENRK1O6
    price: ~$30
  - name: PetSafe Bolt Laser
    asin: B004798TJO
    price: ~$20
internalLinks:
...
*Want to build the play habit and actually track whether it's making a difference? We're building [CatPlay](https://catplay.app) — a simple iOS app for daily cat play routines. Coming soon.*

---

## Pinterest-Pin-Konzepte (4 Pins)

**Pin 1 — Listicle-Hook**
Text: "7 Cat Toys That Actually Work (Ranked)"
Subtext: "Most end up ignored. These don't."
Visual: Flatlay der 7 Toys auf neutralem Hintergrund

**Pin 2 — Budgetfokus**
Text: "The Best Cat Toy Costs $4"
Subtext: "It's a wire. Your cat will lose its mind."
Visual: Cat Dancer Nahaufnahme + spielende Katze

**Pin 3 — Problem-Lösung**
Text: "Your Cat Is Bored. Here's the Fix."
Subtext: "7 toys that trigger the hunting instinct"
Visual: Katze beim Spielen mit Da Bird, dramatisches Licht

**Pin 4 — Nische: Busy Owner**
Text: "Cat Toys That Play Themselves"
Subtext: "For cats home alone all day"
Visual: SmartyKat Hot Pursuit in Betrieb, Katze im Fokus

---

## Video-Script-Ideen (3 Videos)

**Video 1 — Kurzformat (60 Sek.)**
Hook: "I ranked 7 cat toys so you don't have to waste money"
Format: Quick-cut Reaktionsvideos Katze auf jeden Toy
CTA: "Link in Bio — komplette Rangliste"

**Video 2 — Tutorial (90 Sek.)**
Hook: "Why your cat ignores every toy (and what to do)"
Format: Erklärung Hunting Sequence + Toy-Demo
CTA: "Da Bird wand — Link in Bio"

**Video 3 — Reaktionsvideo**
Hook: "$4 vs $30 cat toy — which wins?"
Format: Side-by-side Cat Dancer vs PetFusion Ambush
CTA: "Spoiler: cheaper one wins"

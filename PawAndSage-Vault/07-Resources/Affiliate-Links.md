...
Amazon Associates tag: `pawandsage21-20` - account active

Rule: this file contains Amazon Associates links only. Do not add Chewy links, direct-brand affiliate links, or any other affiliate network links unless the strategy docs are explicitly updated first.

Legacy article IDs:
- `L1` = Why Your Cat Wakes You Up at 3 AM
- `L2` = 20 Indoor Cat Enrichment Ideas
- `L3` = New Kitten Checklist
...
| Potaroma Flopping Fish | `https://amazon.com/dp/B083S3ZXDF?tag=pawandsage21-20` | B083S3ZXDF | ~$20 | #2 |
...
| Product | Amazon Link | ASIN | Price | Used In Articles |
|---------|------------|------|-------|-----------------|
| Catit Flower Fountain | `https://amazon.com/dp/B0146QXOB0?tag=pawandsage21-20` | B0146QXOB0 | ~$30 | L2, L3 |

## Travel
| Product | Amazon Link | ASIN | Price | Used In Articles |
|---------|------------|------|-------|-----------------|
| Petmate Two-Door Top-Load Carrier | `https://amazon.com/dp/B0062JFGM0?tag=pawandsage21-20` | B0062JFGM0 | ~$40 | L3 |

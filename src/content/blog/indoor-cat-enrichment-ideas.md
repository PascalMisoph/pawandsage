...
[Browse cat wand toys on Chewy →](https://www.chewy.com/s?query=cat+wand+toy)

### 7. A puzzle feeder

A basic puzzle feeder is around $15 and replaces a bowl that takes 30 seconds to empty with a 10-minute foraging session. The Trixie Brain Mover and Catit Senses are both well-reviewed beginner options.

[Browse puzzle feeders on Chewy →](https://www.chewy.com/s?query=cat+puzzle+feeder)

### 8. A treat ball

Even simpler than a puzzle feeder: a hollow ball with a small hole that releases kibble when batted. Around $8. Great for cats who need to slow down their eating.
...
Around $30. Many cats drink more from running water — and a hydrated cat has fewer urinary issues, less constipation, and a better coat.

[Browse cat water fountains on Chewy →](https://www.chewy.com/s?query=cat+water+fountain)

### 15. Vertical space (a single cat shelf)

A wall-mounted cat shelf adds a vertical perch for around $40. Cats live in three dimensions — adding height is the single best spatial change you can make.
